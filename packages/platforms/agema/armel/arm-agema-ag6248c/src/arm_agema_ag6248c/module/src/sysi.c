...
#include "arm_agema_ag6248c_int.h"
#include "arm_agema_ag6248c_log.h"

#include "platform_lib.h"
#include "arm_agema_i2c.h"
...
{ 
    if(strstr(platform,"arm-agema-ag6248c-r0")) {
        platform_id = PLATFORM_ID_POWERPC_AGEMA_AG6248C_R0;
        return ONLP_STATUS_OK;
    }
    if(strstr(platform,"arm-agema-ag6248c-poe-r0")) {
        platform_id = PLATFORM_ID_POWERPC_AGEMA_AG6248C_POE_R0;
        return ONLP_STATUS_OK;
    }
