 ...
 *
 * @file
 * @brief arm_agema_ag6248c Configuration Header
 *
 * @addtogroup arm_agema_ag6248c-config
 * @{
 *
 *****************************************************************************/
...
#include <arm_agema_ag6248c_custom_config.h>
#endif
...
typedef struct arm_agema_ag6248c_config_settings_s {
    /** name */
    const char* name;
    /** value */
    const char* value;
} arm_agema_ag6248c_config_settings_t;

/** Configuration settings table. */
/** arm_agema_ag6248c_config_settings table. */
extern arm_agema_ag6248c_config_settings_t arm_agema_ag6248c_config_settings[];

/**
 * @brief Lookup a configuration setting.
 * @param setting The name of the configuration option to lookup.
 */
const char* arm_agema_ag6248c_config_lookup(const char* setting);

/**
 * @brief Show the compile-time configuration.
 * @param pvs The output stream.
 */
int arm_agema_ag6248c_config_show(struct aim_pvs_s* pvs);

/* <auto.end.cdefs(ONLPSIM_CONFIG_HEADER).header> */

#include "arm_agema_ag6248c_porting.h"
